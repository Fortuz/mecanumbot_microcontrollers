...
enum ControlTableItemAddr{
  ...
  ADDR_PRESENT_CURRENT_BL  = 128,
  ADDR_PRESENT_CURRENT_BR  = 132,
  ADDR_PRESENT_VELOCITY_FL = 136,
  ADDR_PRESENT_VELOCITY_FR = 140,
  ADDR_PRESENT_VELOCITY_BL = 144,
  ADDR_PRESENT_VELOCITY_BR = 148,
  ADDR_PRESENT_POSITION_FL = 152,
  ADDR_PRESENT_POSITION_FR = 156,
  ADDR_PRESENT_POSITION_BL = 160,
  ADDR_PRESENT_POSITION_BR = 164,
