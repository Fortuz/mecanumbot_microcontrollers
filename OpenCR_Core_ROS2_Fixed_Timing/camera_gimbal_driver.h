...
private:
	...
	static constexpr uint16_t AX_REG_TORQUE_ENABLE = 24;     // 1 byte
	static constexpr uint16_t AX_REG_GOAL_POSITION = 30;     // 2 bytes
	static constexpr uint16_t AX_REG_PRESENT_POSITION = 36;  // 2 bytes
