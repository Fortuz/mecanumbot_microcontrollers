...
void Turtlebot3Controller::getRCdata(float *get_cmd_vel, bool *get_act_state)
{
  uint16_t received_data = 0;

  static float lin_x = 0.0, lin_y = 0.0, ang_z = 0.0; 
  static bool cam_state = 0;
  static bool grabber_state = 0;
  ...
  if (rc100_.available())
  {
    ...
    get_act_state[0] = cam_state;
    get_act_state[1] = grabber_state;
  }
}